...
implementation //###############################################################
  ...
  procedure Task_531();
    ...
    begin
      ...
      writeln('Введите размерность последовательности n (n > 1):');     // Просим...
      ...
      if n < 2 then                       // В случае ошибки, так и говорим
        ...
        begin
         ...
         // Действуем от начала и до предпоследнего элемента
         for i := 1 to n - 2 do          
            begin
  ...
  procedure Task_534_a();
    ...
    begin
      ...
      readln(n);                          // Получаем размерность будущего списка
    ...
    begin
      ...
      if (n < 1) or (m < 1) then
        ...
        begin
          ...
          // Сравниваем значение m с единицей, ибо, при m = 1, функция Take_Out_Task_545(LH, m) будет бесконечно зациклена
          if m <> 1 then
